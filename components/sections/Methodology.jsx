...
export default function Methodology() {
  ...
  return (
    ...
    >
      ...
      <div id="meth-grid" style={{ maxWidth: 1240, margin: '0 auto', position: 'relative', zIndex: 1, display: 'grid', gridTemplateColumns: '1fr 1.45fr', gap: 80, alignItems: 'center' }}>
        ...
        <Reveal delay={80}>
          <div id="meth-cards" style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
            {/* Left col — higher */}
            ...
            <div id="meth-col2" style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 16, marginTop: 48 }}>
      ...
      <style>{`
        @media (max-width: 860px) {
          #meth-grid { grid-template-columns: 1fr !important; gap: 48px !important; padding: 72px 20px 80px !important; }
          #meth-cards { flex-wrap: wrap !important; }
          #meth-cards > div { flex: 1 1 calc(50% - 8px) !important; }
          #meth-col2 { margin-top: 0 !important; }
        }
        @media (max-width: 560px) {
          #meth-grid { padding: 56px 16px 64px !important; }
          #meth-cards > div { flex: 1 1 100% !important; }
        }
      `}</style>
    </section>
  )
