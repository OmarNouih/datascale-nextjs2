  ...
  return (
    <div
      ...
      style={{
        ...
        background: '#ffffff',
        border: `1px solid ${hov ? 'rgba(13,138,109,0.4)' : 'rgba(0,0,0,0.08)'}`,
        borderRadius: 14,
        transition: 'all 0.32s cubic-bezier(0.4,0,0.2,1)',
        transform: hov ? 'translateY(-5px)' : 'translateY(0)',
        boxShadow: hov
          ? '0 16px 48px rgba(13,138,109,0.12), 0 4px 16px rgba(0,0,0,0.06)'
    ...
    >
      ...
      <div style={{
        height: 3,
        background: hov
          ? 'linear-gradient(90deg, #0d8a6d, #17b894)'
          : 'linear-gradient(90deg, rgba(13,138,109,0.5), rgba(23,184,148,0.25))',
      ...
      <div style={{ padding: '28px 26px 20px' }}>
        <div style={{
          ...
          background: hov ? 'rgba(13,138,109,0.12)' : 'rgba(13,138,109,0.07)',
          border: `1px solid ${hov ? 'rgba(13,138,109,0.4)' : 'rgba(13,138,109,0.18)'}`,
          borderRadius: 10, color: '#0d8a6d',
        ...
        <div style={{
          ...
          color: hov ? '#0d8a6d' : 'rgba(0,0,0,0.32)',
          transition: 'color 0.32s',
        }}>
          {card.title}
        </div>
      ...
      <div style={{
        ...
        background: hov ? 'rgba(13,138,109,0.22)' : 'rgba(0,0,0,0.07)',
        transition: 'background 0.32s',
      }} />
      ...
      <div style={{ padding: '20px 26px 26px', flex: 1, display: 'flex', flexDirection: 'column', gap: 12 }}>
        <p style={{
          ...
          color: hov ? 'rgba(10,21,18,0.62)' : 'rgba(10,21,18,0.46)',
          margin: 0,
          transition: 'color 0.32s',
        }}>
          {card.dnaDesc}
        ...
        <div style={{
          marginTop: 'auto',
          padding: '11px 13px',
          background: hov ? 'rgba(13,138,109,0.06)' : 'rgba(0,0,0,0.025)',
          border: `1px solid ${hov ? 'rgba(13,138,109,0.2)' : 'rgba(0,0,0,0.07)'}`,
          borderRadius: 7,
          transition: 'all 0.32s',
        }}>
          <p style={{
            ...
            color: hov ? 'rgba(10,21,18,0.58)' : 'rgba(10,21,18,0.4)',
            margin: 0,
            transition: 'color 0.32s',
          }}>
            {card.desc}
    ...
    <div style={{ display: 'flex', alignItems: 'stretch', flex: 1, minWidth: 0 }}>
      ...
      >
        ...
        <div style={{ padding: '14px 14px 0', flex: 1 }}>
          <p style={{
            ...
            color: hov ? 'rgba(10,21,18,0.58)' : 'rgba(10,21,18,0.38)',
            margin: 0,
      ...
      {!isLast && (
        <div style={{
          ...
          <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="rgba(10,21,18,0.18)" strokeWidth="2.5">
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        backgroundImage: 'radial-gradient(circle, rgba(10,21,18,0.055) 1px, transparent 1px)',
          ...
          <div style={{
            ...
            <div>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, marginBottom: 18 }}>
                <div style={{ width: 24, height: 1.5, background: '#0d8a6d' }} />
                <span style={{
                  fontFamily: "'Avenir Next', 'Avenir', 'Century Gothic', sans-serif",
            ...
            <div style={{
              ...
              <div>
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
                  <div style={{ width: 20, height: 1.5, background: '#0d8a6d' }} />
                  <span style={{
                    fontFamily: "'Avenir Next', 'Avenir', 'Century Gothic', sans-serif",
