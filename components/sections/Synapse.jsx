...
function FeatureCard({ f }) {
  ...
  return (
    ...
    >
      {/* Decorative shapes — corner circle + diagonal line */}
      {!hov && <>
        <div style={{ position: 'absolute', top: -18, right: -18, width: 56, height: 56, borderRadius: '50%', border: '1.5px solid rgba(34,244,189,0.13)', pointerEvents: 'none' }} />
        <div style={{ position: 'absolute', top: -8, right: -8, width: 28, height: 28, borderRadius: '50%', border: '1px solid rgba(34,244,189,0.09)', pointerEvents: 'none' }} />
        <div style={{ position: 'absolute', bottom: 10, right: 24, width: 32, height: 1, background: 'rgba(34,244,189,0.12)', transform: 'rotate(-35deg)', pointerEvents: 'none' }} />
      </>}

      {/* Icon — no container, raw SVG */}
  ...
  return (
    <section id="synapse" style={{ background: '#040807', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative', zIndex: 1, padding: '96px 28px 100px' }}>
        ...
        <Reveal delay={60}>
          <div style={{ position: 'relative', display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', marginBottom: 64, padding: '0 40px' }}>
